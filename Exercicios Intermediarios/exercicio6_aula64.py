...
position_initial = 0
duplicado = 0
lista_teste = lista_de_listas_de_inteiros[3]
print(lista_teste)
for i in range(len(lista_teste)):
    for j in range(10):
        print(lista_teste[i], lista_teste[j])

        if lista_teste[i] == lista_teste[j]:
            position_initial = i
            position_final = j
            duplicado = lista_teste[j]


print(position_initial, position_final, duplicado)
